          ...
          const checkLimit = (sender) => {
           ...
           return false
			...
			case 'vinta':
				...
				client.sendMessage(from, vintage, image, {caption: 'Nih kak udah jadi.. ${vin}', quoted: mek})
			...
			case 'setppbot':
				...
				client.updatePresence(from, Presence.composing) 
				if (!isQuotedImage) return reply(`Oh my owner.. Kirim gambar dengan caption ${prefix}setbotpp atau tag gambar yang sudah dikirim`)
